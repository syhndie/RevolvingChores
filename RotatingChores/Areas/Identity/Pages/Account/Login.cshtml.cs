...
namespace RotatingChores.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : BasePageModel
    {
        ...
        public LoginModel(UserManager<RotatingChoresUser> userManager, SignInManager<RotatingChoresUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        {
            returnUrl = returnUrl ?? Url.Content("~/Chores/Index");
